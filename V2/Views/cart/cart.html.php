<div class="cart-container">
    <div class="formulaire">
        ...
        <form id="myForm" action="processCart" method="post">
            <label for="nom">Nom:</label><br>
            <input type="text" id="nom" name="nom" required>
            <br>

            <label for="prenom">Prénom:</label><br>
            <input type="text" id="prenom" name="prenom" value="<?php echo $_SESSION['login'] ?>" readonly>
            <br>
            ...
            <select id="car" name="car" required>
                ...
                <?php foreach ($carList as $carLists): ?>
                    <option value="<?php echo $carLists['id']; ?>">
                        <?php echo htmlspecialchars($carLists['brand']) . " " . htmlspecialchars($carLists['model']) . " (" . htmlspecialchars($carLists['yearProd']) . ")"; ?>
                    </option>
                <?php endforeach; ?>
            </select>
            <br>
